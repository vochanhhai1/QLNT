...
public class DichvufromPhongAdapter1 extends RecyclerView.Adapter<DichvufromPhongAdapter1.ViewHolder> {
    private List<DataClass> stList;

    public DichvufromPhongAdapter1(List<DataClass> stList) {
        this.stList = stList;
    ...
    @NonNull
    @Override
    public DichvufromPhongAdapter1.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_thongtin,parent,false);
        return new DichvufromPhongAdapter1.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DichvufromPhongAdapter1.ViewHolder holder, int position) {
